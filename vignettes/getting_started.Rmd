...
The IFN also provides geographic layers grouping together different forest regions. As these layers are heavy, they are stored in another package (`happifndata`)[https://github.com/paul-carteron/happifndata]. To load them, use `check_happifndata()`. For the moment, four data sets are available : 
